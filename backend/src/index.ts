...
import cosplayRoutes from './routes/cosplay.routes.js';
import stagingFanartRoutes from './routes/staging-fanart.routes.js';
import monitorTargetRoutes from './routes/monitor-target.routes.js';
...
app.use('/api/monitor-targets', monitorTargetRoutes);
